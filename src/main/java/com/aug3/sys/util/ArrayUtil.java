...
public final class ArrayUtil {
    ...
    // a template for merge-based sorts which uses extra memory to speed up
    // merging
    private static abstract class ArrayMergeSorterTemplate<T> extends ArraySorterTemplate<T> {

        private final int threshold; // maximum length of a merge that can be
                                     // made using extra memory
        private final T[] tmp;
        ...
        protected void merge(int lo, int pivot, int hi, int len1, int len2) {
            if (len1 <= threshold) {
                ...
                // since this method recurses to run merge on smaller arrays, it
                // will
     ...
     * uses the quick sort algorithm, but falls back to insertion sort for small
     * arrays.
     * 
     * @param fromIndex
     ...
     * quick sort algorithm, but falls back to insertion sort for small arrays.
     */
    ...
    /**
     * Sorts the given array slice in natural order. This method uses the quick
    ...
    /**
     * Sorts the given array slice using the {@link Comparator}. This method
     * uses the merge sort algorithm, but falls back to insertion sort for small
     * arrays.
     * 
     * @param fromIndex
     *            start index (inclusive)
    ...
    /**
     * Sorts the given array using the {@link Comparator}. This method uses the
     * merge sort algorithm, but falls back to insertion sort for small arrays.
     */
    ...
    /**
     * Sorts the given array slice using the {@link Comparator}. This method
     * uses the TimSort algorithm, but falls back to binary sort for small
     * arrays.
     * 
     * @param fromIndex
     *            start index (inclusive)
    ...
    /**
     * Sorts the given array using the {@link Comparator}. This method uses the
     * TimSort algorithm, but falls back to binary sort for small arrays.
     */
    ...
    /**
     * Sorts the given array slice using the {@link Comparator}. This method
     * uses the insertion sort algorithm. It is only recommended to use this
     * algorithm for partially sorted small arrays!
     * 
     * @param fromIndex
     *            start index (inclusive)
     * @param toIndex
     ...
     * for partially sorted small arrays!
     */
    ...
    /**
     * Sorts the given array in natural order. This method uses the insertion
     * sort algorithm. It is only recommended to use this algorithm for
     * partially sorted small arrays!
     */
    ...
    /**
     * Sorts the given array slice using the {@link Comparator}. This method
     * uses the binary sort algorithm. It is only recommended to use this
     * algorithm for small arrays!
     * 
     * @param fromIndex
     *            start index (inclusive)
     * @param toIndex
    ...
    /**
     * Sorts the given array using the {@link Comparator}. This method uses the
     * binary sort algorithm. It is only recommended to use this algorithm for
     * small arrays!
     */
    ...
    /**
     * Sorts the given array slice in natural order. This method uses the binary
     * sort algorithm. It is only recommended to use this algorithm for small
     * arrays!
     * 
     * @param fromIndex
     *            start index (inclusive)
